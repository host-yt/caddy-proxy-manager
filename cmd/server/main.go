...
import (
	...
	"github.com/hostyt/proxy-gateway/internal/cloudflare"
	...
	"github.com/hostyt/proxy-gateway/internal/nodejoin"
	"github.com/hostyt/proxy-gateway/internal/notify"
...
// panelPublicHost extracts the bare hostname from APP_URL ("https://proxy.host.yt"
// → "proxy.host.yt"). Returns "" if APP_URL is malformed or missing, in
